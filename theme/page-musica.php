...
<div class="w-full max-w-[1350px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] gap-y-5 gap-x-5 justify-items-center mt-8 mx-auto px-5">
  ...
  <div class="order-2 w-full max-w-5xl">
    ...
    <section class="mt-10">
      <h5 class="text-h5 text-gray-100">Musica</h5>
      <div class="mt-4 grid grid-cols-1 md:grid-cols-[1fr_320px] gap-6">
        <div class="mt-6 flex flex-col gap-y-6">
          ...
          <div class="rounded-lg border border-blue-100 flex flex-row items-center gap-4 p-4 pr-10 hover:bg-[#FFF3EC] hover:border-2 hover:border-[#FFE2CE]">
            <div class="rounded-lg w-24 h-24 bg-gray-100">
              <div class="p-2">
                <img src="<?php echo get_template_directory_uri(); ?>/images/img_09.png" alt="" class="">
                <div class="text-h1 text-right text-orange-laNota">01</div>
              </div>
            </div>
            <div class="text-lightBlue-900">
              <p class="text-body-b text-lightBlue-900">Eladio Carrion</p>
              <span class="text-s">Lo que sube tiene que bajar</span>
            </div>
          </div>
