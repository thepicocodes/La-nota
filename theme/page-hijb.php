...
<div class="w-full max-w-[1354px] grid grid-cols-1 xl:grid-cols-[160px_1fr_160px] justify-items-center gap-y-5 gap-x-5 mt-8 mx-auto px-5">
  ...
  <div class="hidden xl:block order-3 w-full xl:max-w-40 h-40 xl:h-[600px] bg-[#D6CCFF]"></div>
  <!--  -->
  <section class="order-2 w-full max-w-5xl">
    <!-- ad -->
    <div class="w-full h-[274px] mb-5 px-3 py-3 bg-[#F1F3F7]">
      <div class="w-full h-full bg-[#D6CCFF]"></div>
    </div>
    <!--  -->
    <section class="rounded-lg relative w-full h-[560px] md:h-[300px]">
      ...
      <div class="rounded-lg p-4 flex flex-col md:flex-row gap-5 absolute top-5 right-5 left-5 bg-[#FFFFFFCC]/80">
    ...
    <div class="rounded-md w-full max-w-[752px] h-[114px] mx-auto mt-10 p-4 bg-[#F1F3F7]">
      <div class="w-full h-full bg-[#D6CCFF]"></div>
    </div>

    <section class="mt-10">
      <div class="flex items-center justify-between">
        <h5 class="text-h5 text-gray-100">Programación</h5>
        <a href="" class="flex items-center gap-x-2 font-bold text-green-hijb2">
          Ver más
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 fill-green-hijb2" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            <path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
          </svg>
        </a>
      </div>
      <div class="mt-6 flex flex-col gap-y-2">
        <div class="rounded-lg border-2 border-[#D7EDD0] flex flex-row items-center gap-2 p-4 pr-10 bg-[#F7FFF0]">
          <div class="w-full flex flex-row items-center justify-between">
            <div class="text-lightBlue-900">
              <p class="text-body-b text-lightBlue-900">Esto no tiene nombre</p>
              <span class="text-s">Locutor 1 y Locutor 2</span>
            </div>
            <div class="flex flex-row items-center gap-x-4 text-body-b text-lightBlue-900">
              12:00PM
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4" viewBox="0 0 320 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
        ...
        <div class="rounded-lg border-2 border-[#D7EDD0] flex flex-row items-center gap-4 p-4 pr-10 bg-[#F7FFF0]">
          <div class="w-full flex flex-row items-center justify-between">
            <div class="text-lightBlue-900">
              <p class="text-body-b text-lightBlue-900">Esto no tiene nombre</p>
              <span class="text-s">Locutor 1 y Locutor 2</span>
